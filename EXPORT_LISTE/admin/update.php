<?php
// admin/update.php — Mise à jour / désinstallation du module EXPORT_LISTE.
...
upd_render_common_page(dirname(__DIR__), [
    'h1'    => 'Export liste — Mise à jour du module',
    'title' => 'Export liste — Mise à jour',
    'back'  => ['url' => $CFG->ROOT_DIR . 'Modules/Custom/EXPORT_LISTE/index.php', 'label' => 'Retour à l\'export'],
]);
